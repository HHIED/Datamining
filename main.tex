...
\thesistitle{Ali og den forsvundne BMW} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
\supervisor{Mathias Emil \textsc{Hansen}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
\examiner{} % Your examiner's name, this is not currently used anywhere in the template, print it elsewhere with \examname
\degree{Software Engineering 4. semester} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
\author{Casper \textsc{Middelhede}\\
	Ditlev \textsc{Selz Stoltenberg Stjerne}\\
	Lars Bo \textsc{Meixner}\\
	Lasse Bjørn \textsc{Hansen}\\
	Simon \textsc{Flensted}\\
	Steffen \textsc{Hansen}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\group{Group 3} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
\textsc{\Large Software Engineering 4. Semester}\\[0.5cm] % Thesis type
...
\noindent\Huge{\enquote{\itshape Did you clean and build?}}\bigbreak
...
%\thispagestyle{plain}
\section*{Editorial}
\addchaptertocentry{Editorial}

\begin{tabular}{p{9cm} p{5cm}}
{\textbf{\emph{Lasse Bjørn Hansen}}
\begin{itemize}
...
\item Conclusion
\end{itemize}} \\
{\textbf{\emph{Simon Haugaard Flensted}}
\begin{itemize}
\setlength\itemsep{0.05em}
\item Introduction
\item Requirements
