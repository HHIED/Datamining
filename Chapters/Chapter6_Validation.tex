...
Most of the tests of the recommendation part is tested with the number of recommendations being 5, which is why they must return a string array of 5. \\
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.4]{recallAccuracy}
